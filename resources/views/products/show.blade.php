...
@section('contents')
   ...
   <div class="col mb-3">
    ...
    <div class="col mb-3">
        ...
        <input type="text" name="description" class="form-control" placeholder="Description" readonly>{{ $product->description }}</textarea>
    </div>
    </div>
    <div class="row">
   <div class="col mb-3">
    ...
    <div class="col mb-3">
        ...
        <input type="text" name="updated_at" class="form-control" placeholder="Created At" value="{{ $product->created_at }}" readonly>
    </div>
    </div>
    @endsection
